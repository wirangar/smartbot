...
MESSAGES = {
    'fa': {
        ...
        "welcome_back": "سلام مجدد! به منوی اصلی خوش آمدید.",
        "ask_first_name": "عالی! برای شروع، لطفاً نام خود را وارد کنید:",
        "ask_last_name": "متشکرم. اکنون نام خانوادگی خود را وارد کنید:",
        "ask_age": "لطفاً سن خود را به عدد وارد کنید:",
        "ask_email": "و در آخر، ایمیل خود را وارد کنید:",
        "invalid_age": "سن نامعتبر است. لطفاً دوباره یک عدد وارد کنید.",
        "invalid_email": "ایمیل نامعتبر است. لطفاً دوباره وارد کنید.",
        "db_error": "مشکلی در ذخیره اطلاعات شما رخ داد. لطفاً بعداً دوباره امتحان کنید.",
        "registration_success": "✅ ثبت‌نام شما با موفقیت انجام شد! به منوی اصلی خوش آمدید.",
        "admin_new_user_notification": "🎉 کاربر جدید ثبت‌نام کرد!\n\nID: {id}\nنام: {name}\nسن: {age}\nایمیل: {email}\nزبان: {lang}",
        "profile_text": "👤 *پروفایل شما*\n\n*نام:* {first_name}\n*نام خانوادگی:* {last_name}\n*سن:* {age}\n*ایمیل:* {email}\n*امتیاز:* {score} ✨",
        "profile_not_found": "اطلاعات پروفایل شما یافت نشد. لطفاً با /start ثبت‌نام کنید.",
        "profile_error": "خطایی در دریافت اطلاعات پروفایل رخ داد.",
        "subscribe_prompt": "آیا مایلید یادآوری‌های مربوط به ددلاین‌های مهم را دریافت کنید؟",
        "subscribe_success": "عالی! شما برای دریافت یادآوری‌ها مشترک شدید.",
        "unsubscribe_success": "شما اشتراک خود را لغو کردید.",
        "subscribe_error": "خطایی در به‌روزرسانی وضعیت اشتراک شما رخ داد.",
        "main_menu_prompt": "به منوی اصلی بازگشتید.",
        "operation_cancelled": "عملیات لغو شد.",
        "category_selected": "شما دسته‌بندی '{category}' را انتخاب کردید. لطفاً یک مورد را انتخاب کنید:",
        "file_send_error": "خطایی در ارسال فایل رخ داد.",
        "file_not_found": "فایل مرتبط یافت نشد.",
        "help_text": "🤖 *راهنمای ربات Scholarino*\n\n- از منوها برای دسترسی به اطلاعات استفاده کنید.\n- برای سوالات خاص، پیام خود را تایپ کنید.\n- برای تماس با مدیر، از دکمه 'تماس با ادمین' استفاده کنید.",
    },
    'en': {
